...
protected:
    ...
    void
    LoadModelAndSkeleton_R(FbxToDmxMap_t &fbxToDmxMap, CDmeModel *pDmeModel, CDmeDag *pDmeDagParent, FbxNode *pFbxNode,
                           bool bAnimation, int nDepth) const;

    CDmeDag *FbxNodeToDmeDag(CDmeDag *pDmeDagParent, FbxNode *pFbxNode, const char *pszDmeType,
                             FbxMatrix *pmOutScale = NULL) const;

    CDmeMesh *FbxShapeToDmeMesh(CDmeDag *pDmeDag, FbxNode *pFbxNode, const FbxMatrix &mScale) const;

    bool FbxMeshToDmeFaceSets(CDmeDag *pDmeDag, CDmeMesh *pDmeMesh, FbxMesh *pFbxMesh,
                              CUtlVector<int> &nPolygonToFaceSetMap) const;

    bool FindMaterialResource(CUtlString &sOutMaterialPath, const char *pszInMaterialName,
                              CUtlVector<CUtlString> &materialSearchErrorList) const;

    bool GetFbxMaterialPathFromFbxFileTexture(CUtlString &sMaterialPath, FbxFileTexture *pFileTexture,
                                              CUtlVector<CUtlString> &materialSearchErrorList) const;

    bool GetFbxMaterialPath(CUtlString &sMaterialPath, FbxSurfaceMaterial *pFbxMat,
                            CUtlVector<CUtlString> &materialSearchErrorList) const;
    ...
    void
    AddBlendShape(CDmeDag *pDmeDag, const FbxToDmxMap_t &fbxToDmxMap, CDmElement *pDmeRoot, FbxNode *pFbxNode) const;
    ...
    void
    LoadAnimation(CDmElement *pDmeRoot, CDmeModel *pDmeModel, const FbxToDmxMap_t &fbxToDmxMap, FbxScene *pFbxScene,
                  FbxNode *pFbxRootNode, FbxTime::EMode eFbxTimeMode) const;
    ...
    void
    ComputeVstFlexSliderAnimDataList_R(FbxAnimLayer *pFbxAnimLayer, CUtlVector<struct FbxDmxAnimData_t *> &animDataList,
                                       class CDmeChannelsClip *pDmeChannelsClip,
                                       const CDmFbxSerializer::FbxToDmxMap_t &fbxToDmxMap, FbxNode *pFbxNode) const;

    void ComputeAnimDataList_R(FbxAnimLayer *pFbxAnimLayer, CUtlVector<struct FbxDmxAnimData_t *> &animDataList,
                               class CDmeChannelsClip *pDmeChannelsClip,
                               const CDmFbxSerializer::FbxToDmxMap_t &fbxToDmxMap, FbxNode *pFbxNode,
                               struct FbxDmxAnimData_t *pAnimDataParent) const;

    void AddColorData(class CDmeVertexData *pDmeVertexData, const CUtlVector<int> &nIndices,
                      const FbxGeometryElementVertexColor *pFbxElement) const;
